...
<script	src="<%=request.getContextPath()%>/scripts/appscripts/users.js">
...
<body>
	...
	<div>
		<br>
		<p align="left">
			<a href="<%=request.getContextPath()%>/showUser.html" ><img src="<%=request.getContextPath() %>/images/add.png" />Add User</a>
		</p>	
		...
		<div id="allusersDiv">
			<table id="all-users-grid"></table>
			<div id="all-users-grid-pager"></div>
		</div>
