...
<script
	src="<%=request.getContextPath()%>/scripts/appscripts/balanceitemreport.js">
...
<body>
	...
	<div id="printDiv"
		...
		<h2 align="center">NEss Screneing</h2>
		<p align="center">
		...
		<div id="balanceitemDiv" align="center">
			<table id="balance-item-grid"></table>
			<div id="balance-item-grid-pager"></div>
		</div>
