...
<script
	src="<%=request.getContextPath()%>/scripts/appscripts/vendors.js">
...
<body>
	<div>
		...
		<div>
			<br>
			<p align="left">
				<a href="<%=request.getContextPath()%>/addVendor.html"><img
					src="<%=request.getContextPath()%>/images/add.png" />Add Vendor</a>
			</p>
		...
		<div id="allvendorsDiv">
			<table id="all-vendors-grid"></table>
			<div id="all-vendors-grid-pager"></div>
		</div>
...
<!-- Botostrap Modal -->
	<div class="modal fade" id="vendorDetailModal"  role="dialog"
		aria-labelledby="vendorDetailModal" style="width: 50%;">
