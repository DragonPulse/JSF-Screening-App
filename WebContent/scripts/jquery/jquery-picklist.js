...
(function($)
{
	$.widget("awnry.pickList",
	{
		...
		_buildControls: function()
		{
			...
			self.addAllButton = $("<button type='button' class=\"ui-state-default ui-corner-all\"/>").click({pickList: self}, self._addAllHandler).html(self.options.addAllLabel).addClass(self.options.addAllClass);
			self.addButton = $("<button type='button' class=\"ui-state-default ui-corner-all\" />").click({pickList: self}, self._addHandler).html(self.options.addLabel).addClass(self.options.addClass);
			self.removeButton = $("<button type='button' class=\"ui-state-default ui-corner-all\" />").click({pickList: self}, self._removeHandler).html(self.options.removeLabel).addClass(self.options.removeClass);
			self.removeAllButton = $("<button type='button' class=\"ui-state-default ui-corner-all\" />").click({pickList: self}, self._removeAllHandler).html(self.options.removeAllLabel).addClass(self.options.removeAllClass);
