...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        defaultPreviewSettings = {
            ...
            html: {width: "175px", height: "100px"},
            text: {width: "80px", height: "90px"},
            video: {width: "175px", height: "100px"},
            audio: {width: "175px", height: "80px"},
            flash: {width: "175px", height: "100px"},
        ...
        previewFile: function (file, theFile, previewId, data) {
            ...
            if (chkTypes && chkMimes) {
                if (cat === 'text') {
                    ...
                    strText=strText.substring(0, 45); 
