...
CREATE TABLE `user_role` (
  ...
  `User_Role_Status` tinyint(4) DEFAULT '0',
  PRIMARY KEY (`User_Role_Id`),
  UNIQUE KEY `idUser_Roles_UNIQUE` (`User_Role_Id`),
...
INSERT INTO `user_role` VALUES (5,'ROLE_ADMIN',1),(6,'ROLE_HR',1),(7,'ROLE_TECH',1),(8,'ROLE_MGR',1);
